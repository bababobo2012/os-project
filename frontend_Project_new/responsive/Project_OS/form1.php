    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 ">
                    <hr>
                <form  action="form1.php" method="POST">  <!-- แท็ก input และแอตทริบิวต์ type="submit" จะกำหนดปุ่นสำหรับส่งข้อมูลไปยังเซิฟเวอร์ 
...
if  ($email <> "")  {
     if ($Member_email == $email) {
        ...
        echo "<br>";
        echo $txt_show;
        echo "<a href= 'Myanmar2.html'>จอง</a>";
     }
    

      else {
        $txt_show= "ไม่เป็นสมาชิก ไม่สามารถจองได้!!";
        echo "<br>";
        echo $txt_show;
     }
